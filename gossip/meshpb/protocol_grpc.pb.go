...
const (
	GossipService_Ping_FullMethodName   = "/GossipService/Ping"
	GossipService_Update_FullMethodName = "/GossipService/Update"
)
...
type GossipServiceClient interface {
	Ping(ctx context.Context, in *EmptyData, opts ...grpc.CallOption) (*EmptyData, error)
	Update(ctx context.Context, in *NewPeerData, opts ...grpc.CallOption) (*EmptyData, error)
}
...
func (c *gossipServiceClient) Ping(ctx context.Context, in *EmptyData, opts ...grpc.CallOption) (*EmptyData, error) {
...
func (c *gossipServiceClient) Update(ctx context.Context, in *NewPeerData, opts ...grpc.CallOption) (*EmptyData, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyData)
	err := c.cc.Invoke(ctx, GossipService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GossipServiceServer interface {
	Ping(context.Context, *EmptyData) (*EmptyData, error)
	Update(context.Context, *NewPeerData) (*EmptyData, error)
...
func (UnimplementedGossipServiceServer) Ping(context.Context, *EmptyData) (*EmptyData, error) {
	return nil, status.Error(codes.Unimplemented, "method Ping not implemented")
}
func (UnimplementedGossipServiceServer) Update(context.Context, *NewPeerData) (*EmptyData, error) {
...
func _GossipService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GossipServiceServer).Ping(ctx, req.(*EmptyData))
	}
	return interceptor(ctx, in, info, handler)
}

func _GossipService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewPeerData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GossipServiceServer).Update(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GossipService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GossipServiceServer).Update(ctx, req.(*NewPeerData))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GossipService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Update",
			Handler:    _GossipService_Update_Handler,
		},
	},
